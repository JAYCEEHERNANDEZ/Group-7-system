      ...
      <main className="flex-1 p-10">
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-gray-700/40 shadow-lg p-6 mt-8 rounded-xl">
          <h3 className="text-lg font-semibold mb-4 text-blue-300">
            Khichdipur – Client Company
          </h3>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-300">
            <p><strong className="text-blue-300">Client Name:</strong> MCD Delhi</p>
            <p><strong className="text-blue-300">Location:</strong> 310, Golf Course Rd, Gurugram</p>

            <p><strong className="text-blue-300">Model:</strong> WTCJF/HB869J0KB</p>
